<flux:modal name="novo-produto" class="md:w-128">
    <div class="space-y-6">
        <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            @if($pedido_id)
                ...
                <flux:input wire:model="comissao_vendedor" type="number" label="Comissao Vendedor"/>
            @endif
        </div>

        <div class="flex">
            <flux:spacer />
            <flux:button type="submit" variant="primary" wire:click="criar" class="cursor-pointer">Criar Produto</flux:button>
        </div>
    </div>
</flux:modal>