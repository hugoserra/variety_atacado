<flux:modal name="nova-transacao" class="w-full md:w-96">
    <div class="space-y-6">
        <div>
        ...
        <div class="flex">
            <flux:spacer />
            <flux:button type="submit" variant="primary" wire:click="criar" class="cursor-pointer">Criar Transação</flux:button>
        </div>
    </div>
</flux:modal>